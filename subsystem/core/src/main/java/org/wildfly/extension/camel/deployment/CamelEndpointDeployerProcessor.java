...
public class CamelEndpointDeployerProcessor implements DeploymentUnitProcessor {
    ...
    public void deploy(DeploymentPhaseContext phaseContext) throws DeploymentUnitProcessingException {
        ...
        if (warMetaData == null) {
            CamelLogger.LOGGER.warn("WarMetaData not ready");
            return;
        }
        CamelLogger.LOGGER.warn("*** installing deployer");
        final ServiceName deploymentServiceName = UndertowService
                .deploymentServiceName(deploymentUnit.getServiceName());
