...
public class CamelEndpointDeployerService implements Service<CamelEndpointDeployerService> {
    ...
    static List<SecurityConstraint> filterConstraints(DeploymentInfo mainDeploymentInfo, URI uri) {
        ...
        for (SecurityConstraint mainSecurityConstraint : mainDeploymentInfo.getSecurityConstraints()) {
            ...
            for (WebResourceCollection mainResourceCollection : mainSecurityConstraint.getWebResourceCollections()) {
                ...
                LOG.warn("*** endpointResourceCollection.getUrlPatterns() = "
            ...
            LOG.warn("*** endpointSecurityConstraint.getWebResourceCollections().size() = "
    ...
    static String diToString(DeploymentInfo di) {
        ...
        return "DeploymentInfo [deploymentName=" + di.getDeploymentName() + "\ndisplayName=" + di.getDisplayName()
                + "\ncontextPath=" + di.getContextPath() + "\nclassLoader=" + di.getClassLoader() + "\nresourceManager="
                + di.getResourceManager() + "\nclassIntrospecter=" + di.getClassIntrospecter() + "\nmajorVersion="
                + di.getMajorVersion() + "\nminorVersion=" + di.getMinorVersion() + "\ncontainerMajorVersion="
                + di.getContainerMajorVersion() + "\ncontainerMinorVersion=" + di.getContainerMinorVersion()
                ...
                + "\nloginConfig=" + di.getLoginConfig() + "\nidentityManager=" + di.getIdentityManager()
                + "\nconfidentialPortManager=" + di.getConfidentialPortManager() + "\nallowNonStandardWrappers="
                + di.isAllowNonStandardWrappers() + "\ndefaultSessionTimeout=" + di.getDefaultSessionTimeout()
                + "\nservletContextAttributeBackingMap=" + di.getServletContextAttributeBackingMap()
                ...
                + "\ndefaultRequestEncoding=" + di.getDefaultRequestEncoding() + "\ndefaultResponseEncoding="
                + di.getDefaultResponseEncoding() + "\nurlEncoding=" + di.getUrlEncoding() + "\nignoreFlush="
                ...
                + "\nauthenticationMode=" + di.getAuthenticationMode() + "\nexceptionHandler="
                + di.getExceptionHandler() + "\nservlets=" + di.getServlets() + "\nfilters=" + di.getFilters()
                ...
                + "\nservletContextAttributes=" + di.getServletContextAttributes() + "\nlocaleCharsetMapping="
                + di.getLocaleCharsetMapping() + "\nwelcomePages=" + di.getWelcomePages() + "\nerrorPages="
                + di.getErrorPages() + "\nmimeMappings=" + di.getMimeMappings() + "\nsecurityConstraints="
                + di.getSecurityConstraints() + "\nsecurityRoles=" + di.getSecurityRoles() + "\nnotificationReceivers="
                + di.getNotificationReceivers() + "\nauthenticationMechanisms=" + di.getAuthenticationMechanisms()
                + "\nlifecycleInterceptors=" + di.getLifecycleInterceptors() + "\nsessionListeners="
                + di.getSessionListeners() + "\nservletExtensions=" + di.getServletExtensions()
                + "\nprincipalVersusRolesMap=" + di.getPrincipalVersusRolesMap() + "\ninitialHandlerChainWrappers="
                + di.getInitialHandlerChainWrappers() + "\nouterHandlerChainWrappers="
                + di.getOuterHandlerChainWrappers() + "\ninnerHandlerChainWrappers=" + di.getInnerHandlerChainWrappers()
                + "\ninitialSecurityWrapper=" + di.getInitialSecurityWrapper() + "\nsecurityWrappers="
                + di.getSecurityWrappers() + "\ndefaultMultipartConfig=" + di.getDefaultMultipartConfig()
                ...
                + "\npreCompressedResources=" + di.getPreCompressedResources() + "]";
