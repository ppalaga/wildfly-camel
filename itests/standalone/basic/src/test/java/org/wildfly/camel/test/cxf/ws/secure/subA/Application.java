...
public class Application {
    ...
    private final static String KEYSTORE_PATH = System.getProperty("jboss.server.config.dir") + "/server.keystore";
    private static final String KEYSTORE_PASSWORD = "123456";

    // "server" is the alias of the key in "${JBOSS-HOME}/standalone/configuration/application.keystore"
    private final static String TRUSTSTORE_ALIAS_NAME = "cn=server";
