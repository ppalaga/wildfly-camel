...
public class CXFWSElytronSecureProducerIntegrationTest {
    ...
    public static Archive<?> deployment() {
        final WebArchive archive = ShrinkWrap.create(WebArchive.class, WAR_NAME) //
                ...
                .addAsWebInfResource(
                        new StringAsset("<jboss-web><security-domain>client-cert</security-domain>" //
                                +"<servlet>" //
                                +"<servlet-name>/webservices/greeting-secure-cdi</servlet-name>"//
                                +"<servlet-security><roles-allowed>testRole</roles-allowed></servlet-security>"//
                                +"</servlet>"
                                +"</jboss-web>"),
                        "jboss-web.xml")//
