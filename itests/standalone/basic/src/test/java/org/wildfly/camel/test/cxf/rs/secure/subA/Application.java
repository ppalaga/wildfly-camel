...
public class Application {
    ...
    public CxfRsEndpoint createCxfProducerEndpointSub() {
        CxfRsComponent cxfProducerComponent = this.camelContext.getEndpoint("cxfrs:" + CXF_ENDPOINT_SUB_BASE_URI, CxfRsEndpoint.class);
    ...
    public CxfRsEndpoint createCxfProducerEndpointRel() {
        CxfRsComponent cxfProducerComponent = this.camelContext.getEndpoint("cxfrs:" + CXF_ENDPOINT_REL_BASE_URI, CxfRsEndpoint.class);
