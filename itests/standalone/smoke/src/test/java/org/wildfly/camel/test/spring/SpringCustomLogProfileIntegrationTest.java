...
public class SpringCustomLogProfileIntegrationTest {
    ...
    public void testCamelSpringLoggingForProfile() throws Exception {
        CamelContext camelctx = contextRegistry.getCamelContext("spring-logging-context");
        Assert.assertNotNull("spring-logging-context is null", contextRegistry.getCamelContext("spring-logging-context"));
