...
class WildflyHTTPServerEngine extends AbstractHTTPServerEngine {
    ...
    private final CamelEndpointDeploymentSchedulerService camelDynamicDeploymentService;

    WildflyHTTPServerEngine(String protocol, String host, int port) {
        super(protocol, host, port);
        camelDynamicDeploymentService = ServiceLocator.getService(CamelEndpointDeploymentSchedulerService.class);
    ...
    public void addServant(URL nurl, UndertowHTTPHandler handler) {
        ...
        if (camelDynamicDeploymentService != null) {
            try {
                camelDynamicDeploymentService.schedule(nurl.toURI(), handler.getHTTPDestination());
    ...
    public void removeServant(URL nurl) {
        try {
            camelDynamicDeploymentService.unschedule(nurl.toURI());
        } catch (URISyntaxException e) {
            throw new RuntimeException(e);
        }
    }
